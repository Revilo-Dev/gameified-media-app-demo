...
export const themePresets: Record<ThemeMode, ThemeDefinition> = {
  ...
  neonHarbor: { label: "Neon Harbor", description: "Electric harbor blues with a softly glowing cyan signal.", tokens: { text: "#e8fbff", accent: "#22d3ee", secondary: "#38bdf8", error: "#fb7185", info: "#67e8f9", background: "#061520", onBackground: "#e8fbff", surface: "#0b2635", surfaceAlt: "#123b50", textMuted: "#91c7d9", border: "rgba(34,211,238,.22)" } },
  velvetOrbit: { label: "Velvet Orbit", description: "Velvet-black plum panels with pulsing magenta accents.", tokens: { text: "#fff1fb", accent: "#e879f9", secondary: "#c084fc", error: "#fb7185", info: "#a78bfa", background: "#180b1e", onBackground: "#fff1fb", surface: "#2a1034", surfaceAlt: "#40184d", textMuted: "#d6a7d8", border: "rgba(232,121,249,.2)" } },
  moonlitInk: { label: "Moonlit Ink", description: "Ink-blue layers and silver moonlight highlights.", tokens: { text: "#eef2ff", accent: "#a5b4fc", secondary: "#94a3b8", error: "#fb7185", info: "#93c5fd", background: "#0b1020", onBackground: "#eef2ff", surface: "#151c33", surfaceAlt: "#232c49", textMuted: "#aeb9d5", border: "rgba(165,180,252,.2)" } },
  jadeCircuit: { label: "Jade Circuit", description: "Deep jade surfaces energized by a crisp lime circuit glow.", tokens: { text: "#ecfdf5", accent: "#86efac", secondary: "#2dd4bf", error: "#fb7185", info: "#5eead4", background: "#071a16", onBackground: "#ecfdf5", surface: "#10302a", surfaceAlt: "#17483e", textMuted: "#9bc9bb", border: "rgba(134,239,172,.2)" } },
  apricotGlow: { label: "Apricot Glow", description: "Warm apricot panels with a lively pink-orange glow.", tokens: { text: "#3d1f19", accent: "#f97316", secondary: "#fb7185", error: "#dc2626", info: "#f59e0b", background: "#fff2e8", onBackground: "#3d1f19", surface: "#ffe2d1", surfaceAlt: "#ffc9ad", textMuted: "#985f4a", border: "rgba(249,115,22,.2)" } },
};
